...
#[starknet::interface]
trait INFTCollectionFactory<TContractState> {
    ...
    fn set_class_hash_allowed(ref self: TContractState, class_hash: ClassHash, allowed: bool);
}
...
mod NFTCollectionFactory {
    ...
    #[abi(embed_v0)]
    impl NFTCollectionFactoryImpl of super::INFTCollectionFactory<ContractState> {
        fn deploy_new_nft_collection(
            ...
            assert(
                self.class_hash_allowed.read(class_hash), Errors::ERROR_UNWHITELISTED_CLASS_HASH
            );
